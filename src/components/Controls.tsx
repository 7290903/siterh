  ...
  const controlMethods = [
    {
      ...
      image: `${import.meta.env.BASE_URL}images/mobile.png`,
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}images/00023105.jpg`,
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}images/panel.png`,
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}images/auro-sensors.png`,
    },
    {
      ...
      image: `${import.meta.env.BASE_URL}images/alice.png`,
    },
    {
      icon: <ScanFace className="w-full h-full" />,
      title: 'FACE ID',
      ...
      image: `${import.meta.env.BASE_URL}images/face_id.jpg`,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 lg:gap-8">
          {controlMethods.map((method, index) => (
            ...
            >
              <h4 className="text-base md:text-lg lg:text-xl font-light tracking-wide mb-3 md:mb-4 px-3 md:px-4 pt-3 md:pt-4 group-hover:text-amber-500 transition-colors duration-300">
                {method.title}
              </h4>
              
              <div className="px-3 md:px-4 mb-3 md:mb-4">
                <div className="relative aspect-[4/3] md:aspect-[4/3] rounded-lg overflow-hidden bg-black/20 flex items-center justify-center">
                  <img
                    src={method.image}
                    alt={method.title}
              ...
              <div className="px-3 md:px-4 pb-3 md:pb-4 flex-1">
                <p className="text-xs md:text-sm lg:text-base font-light leading-relaxed text-white/60 group-hover:text-white/80 transition-colors duration-300">
                  {method.description}
                </p>
              </div>
            </div>
